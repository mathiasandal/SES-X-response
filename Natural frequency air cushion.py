import numpy as np
from air_cushion import interpolate_fan_characteristics, read_fan_characteristics
...
M = volume_displacement * rho + p_0*A_b/g  # [kg] total mass of the vessel
...
print('Natural period: \t', round(2*np.pi/omega_0, 2), '\t[s]')
